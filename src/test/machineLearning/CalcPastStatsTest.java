...
public class CalcPastStatsTest {
    ...
    public void canSplitHistoricMatchesWithMultipleTeams() {
        ...
        HistoricMatchDbData t1vst2In2016 = new HistoricMatchDbData(team1, team2, 4,2,16,1.2,2.3);
        HistoricMatchDbData t2vst1In2016 = new HistoricMatchDbData(team2, team1, 0,1,16,1.2,2.3);
        HistoricMatchDbData t1vst2In2017 = new HistoricMatchDbData(team1, team2, 3,2,17,1.2,2.3);
        HistoricMatchDbData t2vst1In2017 = new HistoricMatchDbData(team2, team1, 1,1,17,1.2,2.3);
        //t2vst3. t3 wins 1 draws 1 loses 2 - avg 1 t3, avg 1.75 t2
        HistoricMatchDbData t2vst3In2016 = new HistoricMatchDbData(team2, team3, 2,2,16,1.2,2.3);
        HistoricMatchDbData t3vst2In2016 = new HistoricMatchDbData(team3, team2, 3,2,16,1.2,2.3);
        HistoricMatchDbData t2vst3In2017 = new HistoricMatchDbData(team2, team3, 2,1,17,1.2,2.3);
        HistoricMatchDbData t3vst2In2017 = new HistoricMatchDbData(team3, team2, 0,2,17,1.2,2.3);
        //t1vst3. t1 wins 1, draws 3 - avg 1.5 t1, avg 0.75 t3
        HistoricMatchDbData t3vst1In2016 = new HistoricMatchDbData(team3, team1, 3,4,16,1.2,2.3);
        HistoricMatchDbData t1vst3In2016 = new HistoricMatchDbData(team1, team3, 3,3,16,1.2,2.3);
        HistoricMatchDbData t3vst1In2017 = new HistoricMatchDbData(team3, team1, 1,1,17,1.2,2.3);
        HistoricMatchDbData t1vst3In2017 = new HistoricMatchDbData(team1, team3, 3,3,17,1.2,2.3);
